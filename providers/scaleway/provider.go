...
func (p *Provider) createInstance(ctx context.Context, agent *crow.Agent) (*instance.Server, error) {
	if err := p.resolveZones(); err != nil {
		return nil, err
	}
...
func (p *Provider) setCloudInit(ctx context.Context, agent *crow.Agent, inst *instance.Server) error {
