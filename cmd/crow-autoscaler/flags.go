...
var flags = []cli.Flag{
	&cli.StringFlag{
		...
		EnvVars: []string{"WOODPECKER_LOG_LEVEL", "CROW_LOG_LEVEL"},
	},
	&cli.StringFlag{
		...
		EnvVars: []string{"WOODPECKER_RECONCILIATION_INTERVAL", "CROW_RECONCILIATION_INTERVAL"},
	},
	&cli.StringFlag{
		Name:    "pool-id",
		Value:   "1",
		Usage:   "id of the autoscaler pool",
		EnvVars: []string{"WOODPECKER_POOL_ID", "CROW_POOL_ID"},
	},
	&cli.IntFlag{
		Name:    "min-agents",
		Value:   1,
		Usage:   "minimum amount of agents",
		EnvVars: []string{"WOODPECKER_MIN_AGENTS", "CROW_MIN_AGENTS"},
	},
	&cli.IntFlag{
		Name:    "max-agents",
		Value:   10,
		Usage:   "maximum amount of agents",
		EnvVars: []string{"WOODPECKER_MAX_AGENTS", "CROW_MAX_AGENTS"},
	},
	&cli.StringFlag{
	...
	&cli.StringFlag{
		...
		EnvVars: []string{"WOODPECKER_AGENT_IDLE_TIMEOUT", "CROW_AGENT_IDLE_TIMEOUT"},
	},
	&cli.IntFlag{
		Name:    "workflows-per-agent",
		Value:   2,
		Usage:   "max workflows an agent will executed in parallel",
		EnvVars: []string{"WOODPECKER_WORKFLOWS_PER_AGENT", "CROW_WORKFLOWS_PER_AGENT"},
	},
	&cli.StringFlag{
		Name:    "server-url",
		Value:   "http://localhost:8000",
		Usage:   "crow server address",
		EnvVars: []string{"WOODPECKER_SERVER", "CROW_SERVER"},
	},
	&cli.StringFlag{
		Name:     "server-token",
		Usage:    "crow api token",
		EnvVars:  []string{"WOODPECKER_TOKEN", "CROW_TOKEN"},
		FilePath: os.Getenv("WOODPECKER_TOKEN_FILE"),
	},
	&cli.StringFlag{
		Name:    "grpc-addr",
		Value:   "crow-server:9000",
		Usage:   "grpc address of the crow server",
		EnvVars: []string{"WOODPECKER_GRPC_ADDR", "CROW_GRPC_ADDR"},
	},
	&cli.BoolFlag{
		Name:    "grpc-secure",
		Value:   false,
		Usage:   "use secure grpc connection to the crow server",
		EnvVars: []string{"WOODPECKER_GRPC_SECURE", "CROW_GRPC_SECURE"},
	},
	&cli.StringFlag{
		Name:    "provider",
		Value:   "",
		Usage:   "cloud provider to use",
		EnvVars: []string{"WOODPECKER_PROVIDER", "CROW_PROVIDER"},
	},
	&cli.StringFlag{
		Name:    "agent-image",
		Value:   "crowci/crow-agent:next",
		Usage:   "agent image to use",
		EnvVars: []string{"WOODPECKER_AGENT_IMAGE", "CROW_AGENT_IMAGE"},
	},
	&cli.StringSliceFlag{
		Name:    "agent-env",
		Usage:   "additional agent environment variables as list with key=value pairs",
		EnvVars: []string{"WOODPECKER_AGENT_ENV", "CROW_AGENT_ENV"},
	},
	&cli.StringFlag{
		Name:    "filter-labels",
		Value:   "",
		Usage:   "filter for specific tasks using labels",
		EnvVars: []string{"WOODPECKER_FILTER_LABELS", "CROW_FILTER_LABELS"},
	},
}
